...
| 名称 | ファイル一覧を確認 |
| アクター | ユーザー |
| 事前条件 | コピー元フォルダが設定されている |
| 事後条件 | ファイル一覧が表示される |
| 基本フロー | 1. ユーザーが「確認」ボタンをクリック<br/>2. ファイル一覧の取得が開始される<br/>3. ステータスが「ファイル一覧を取得中...」に変更<br/>4. ファイル一覧がDataGridに表示される<br/>5. ファイル数と合計サイズが表示される<br/>6. ステータスが「確認完了」に変更 |
| 代替フロー | 2a. コピー元が存在しない → エラーメッセージ表示 |
